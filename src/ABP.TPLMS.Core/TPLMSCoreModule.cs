...
namespace ABP.TPLMS
{
    ...
    public class TPLMSCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.Settings.SettingEncryptionConfiguration.DefaultPassPhrase = TPLMSConsts.DefaultPassPhrase;
            SimpleStringCipher.DefaultPassPhrase = TPLMSConsts.DefaultPassPhrase;
        }
